...
'''
In this file, we display the similarity matrix between all music genres 
Input: Songs lyrics for each genre
Output:  2 similarity matrix - 1: with Latin genre & - 2: without Latin genre
'''
